 ...
 *   https://datatables.net/download/#bs5/dt-1.13.4/cr-1.6.2/r-2.4.1/rr-1.3.3
 *
 * Included libraries:
 *   DataTables 1.13.4, ColReorder 1.6.2, Responsive 2.4.1, RowReorder 1.3.3
 */
...
(function( $, window, document, undefined ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"bs5/dt-1.13.4/cr-1.6.2/r-2.4.1/rr-1.3.3",
